...
def uso_tierra(request, template="encuesta/uso_tierra.html"):
    ...
    print suma
    llaves = {'total uso':'usotierra__total_uso','bosque primario':'usotierra__bosque_primario',
              'bosque secundario':'usotierra__bosque_secundario',
              'tacotales':'usotierra__tacotal','cultivos perennes':'usotierra__cultivos_perennes',
              'cultivos semiperennes':'usotierra__cultivos_semiperennes',
              'cultivos anuales':'usotierra__cultivos_anuales'}
    conteo = {}
    
    for k,v in llaves.items():
        #print type(v)
        conteo[k] = a.aggregate(obj=Count(v__gt=0))
    print conteo
