...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Productores.celular'
        db.add_column(u'encuesta_productores', 'celular',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Productores.celular'
        db.delete_column(u'encuesta_productores', 'celular')
