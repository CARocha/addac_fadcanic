...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SeguridadSaf.rendimiento'
        db.add_column(u'encuesta_seguridadsaf', 'rendimiento',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SeguridadSaf.rendimiento'
        db.delete_column(u'encuesta_seguridadsaf', 'rendimiento')
