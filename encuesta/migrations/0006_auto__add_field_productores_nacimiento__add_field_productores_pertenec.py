...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Productores.nacimiento'
        db.add_column(u'encuesta_productores', 'nacimiento',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Productores.pertenece'
        db.add_column(u'encuesta_productores', 'pertenece',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Productores.activo'
        db.add_column(u'encuesta_productores', 'activo',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Productores.nacimiento'
        db.delete_column(u'encuesta_productores', 'nacimiento')

        # Deleting field 'Productores.pertenece'
        db.delete_column(u'encuesta_productores', 'pertenece')

        # Deleting field 'Productores.activo'
        db.delete_column(u'encuesta_productores', 'activo')
