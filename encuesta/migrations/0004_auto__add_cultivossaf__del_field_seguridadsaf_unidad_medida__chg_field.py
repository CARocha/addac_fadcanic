...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CultivosSaf'
        db.create_table(u'encuesta_cultivossaf', (
        ...
        db.send_create_signal(u'encuesta', ['CultivosSaf'])

        # Deleting field 'SeguridadSaf.unidad_medida'
        db.delete_column(u'encuesta_seguridadsaf', 'unidad_medida')


        # Renaming column for 'SeguridadSaf.cultivos' to match new field type.
        db.rename_column(u'encuesta_seguridadsaf', 'cultivos', 'cultivos_id')
        # Changing field 'SeguridadSaf.cultivos'
        db.alter_column(u'encuesta_seguridadsaf', 'cultivos_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['encuesta.CultivosSaf']))
        # Adding index on 'SeguridadSaf', fields ['cultivos']
        db.create_index(u'encuesta_seguridadsaf', ['cultivos_id'])


    def backwards(self, orm):
        # Removing index on 'SeguridadSaf', fields ['cultivos']
        db.delete_index(u'encuesta_seguridadsaf', ['cultivos_id'])

        # Deleting model 'CultivosSaf'
        db.delete_table(u'encuesta_cultivossaf')

        # Adding field 'SeguridadSaf.unidad_medida'
        db.add_column(u'encuesta_seguridadsaf', 'unidad_medida',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


        # Renaming column for 'SeguridadSaf.cultivos' to match new field type.
        db.rename_column(u'encuesta_seguridadsaf', 'cultivos_id', 'cultivos')
        # Changing field 'SeguridadSaf.cultivos'
        db.alter_column(u'encuesta_seguridadsaf', 'cultivos', self.gf('django.db.models.fields.IntegerField')())
