...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Productores.grupo'
        db.add_column(u'encuesta_productores', 'grupo',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Productores.departamento'
        db.add_column(u'encuesta_productores', 'departamento',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Finca.person'
        db.add_column(u'encuesta_finca', 'person',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Productores.grupo'
        db.delete_column(u'encuesta_productores', 'grupo')

        # Deleting field 'Productores.departamento'
        db.delete_column(u'encuesta_productores', 'departamento')

        # Deleting field 'Finca.person'
        db.delete_column(u'encuesta_finca', 'person')
